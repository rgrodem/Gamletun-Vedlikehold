    ...
    <>
      ...
      {equipment.length > 0 ? (
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-2xl p-12 text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">Ingen utstyr registrert enn├Ñ</h3>
          <p className="text-gray-600 mb-6">Kom i gang ved ├Ñ legge til ditt f├©rste utstyr!</p>
          <button
            onClick={() => setShowAddModal(true)}
